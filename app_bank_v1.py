...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\nXXX Operação falhou! Você não tem possui saldo suficiente.")
...
def recuperar_conta_cliente(cliente):
    if not cliente.contas:
        ...
        return None  # Adicionei esse retorno para corrigir a falta de retorno
...
def exibir_extrato(clientes):
    ...
    if not transacoes:
        ...
        for transacao in transacoes:
            extrato += f"\n{transacao['tipo']}:\n\tR$ {transacao['valor']:.2f}"  # Correção aqui
...
def criar_conta(numero_conta, clientes, contas):
    ...
    contas.append(conta)  # Corrigido para adicionar a "contas"
...
def listar_contas(contas):
    for conta in contas:
        print("=" * 100)
        print(str(conta))  # Removido textwrap.dedent()
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            listar_contas(contas)  # Corrigido para passar a lista de contas
